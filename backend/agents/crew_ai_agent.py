...
senior_research_analyst = Agent(
    ...
    goal="Research, analyze, and synthesize comprehensive information on hiring trends and prediction systems from reliable web sources",
...
research_task = Task(
    description="""
    1. Conduct comprehensive research on hiring trends and prediction systems including:
